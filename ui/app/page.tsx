...
export default function Home() {
  ...
  return (
    <main className="relative min-h-[200vh] bg-black text-white overflow-hidden">
      ...
      {/* Hero Content */}
      <div id="hero" className="relative z-20 container mx-auto px-6 lg:px-12 pt-24 pb-32 min-h-screen flex flex-col justify-center">
        <div className="max-w-3xl">
          ...
          <div className="flex items-center gap-3 mb-12 animate-fade-in">
            ...
            <span className="text-sm text-zinc-300">The agentic kit for Stellar DeFi.</span>
          </div>
          ...
          <p className="text-lg md:text-xl text-zinc-400 mb-12 animate-fade-in-up animation-delay-200">
            Stellar DeFi in plain language. Check balances, swap XLM ↔ USDC, create trustlines, and get quotes—all through an AI agent.
          </p>
              ...
              <div className="grid md:grid-cols-2 gap-8">
                <div className="relative rounded-2xl border border-zinc-800 p-3">
                  ...
                  <div className="relative bg-(#0a0a0a) rounded-xl p-8">
                    <h3 className="text-2xl font-light mb-4">Check balance</h3>
                    <p className="text-zinc-400 leading-relaxed mb-6">
                      Get token balances for any Stellar address on mainnet or testnet via Horizon.
                    </p>
                    <a
                ...
                <div className="relative rounded-2xl border border-zinc-800 p-3">
                  ...
                  />
                  <div className="relative bg-(#0a0a0a) rounded-xl p-8">
                    <h3 className="text-2xl font-light mb-4">Swap assets</h3>
                    <p className="text-zinc-400 leading-relaxed mb-6">
                      Swap XLM ↔ USDC via SoroSwap. Quote first, then execute with your key. Mainnet-ready.
                    </p>
                    <a
                      href="https://github.com/stellar/stellar-agent-kit"
                      target="_blank"
                ...
                <div className="relative rounded-2xl border border-zinc-800 p-3">
                  ...
                  />
                  <div className="relative bg-(#0a0a0a) rounded-xl p-8">
                    <h3 className="text-2xl font-light mb-4">Create trustline</h3>
                    <p className="text-zinc-400 leading-relaxed mb-6">
                      Create a USDC trustline so your account can receive and hold USDC on mainnet or testnet.
                    </p>
                    <a
                      href="https://github.com/stellar/stellar-agent-kit"
                      target="_blank"
                ...
                <div className="relative rounded-2xl border border-zinc-800 p-3">
                  ...
                  />
                  <div className="relative bg-(#0a0a0a) rounded-xl p-8">
                    <h3 className="text-2xl font-light mb-4">Get swap quote</h3>
                    <p className="text-zinc-400 leading-relaxed mb-6">
                      Get a quote only—no execution, no private key. Perfect for checking rates before you swap.
                    </p>
                    <a
                      href="https://github.com/stellar/stellar-agent-kit"
                      target="_blank"
            ...
            <TabsContent value="flow" className="mt-8">
              <div className="grid md:grid-cols-2 gap-8">
                <div className="relative rounded-2xl border border-zinc-800 p-3">
                  ...
                  />
                  <div className="relative bg-(#0a0a0a) rounded-xl p-8">
                    <h3 className="text-2xl font-light mb-4">You ask</h3>
                    <p className="text-zinc-400 leading-relaxed mb-6">
                      Talk in plain language. e.g. &ldquo;Swap 0.2 XLM to USDC&rdquo; or &ldquo;Check my balance.&rdquo;
                    </p>
                    <a
                      href="https://github.com/stellar/stellar-agent-kit"
                      target="_blank"
                ...
                <div className="relative rounded-2xl border border-zinc-800 p-3">
                  ...
                  />
                  <div className="relative bg-(#0a0a0a) rounded-xl p-8">
                    <h3 className="text-2xl font-light mb-4">Agent chooses tool</h3>
                    <p className="text-zinc-400 leading-relaxed mb-6">
                      The LLM picks the right tool (check_balance, swap_asset, create_trustline, get_swap_quote) and parameters.
                    </p>
                    <a
                      href="https://github.com/stellar/stellar-agent-kit"
                      target="_blank"
                ...
                <div className="relative rounded-2xl border border-zinc-800 p-3">
                  ...
                  />
                  <div className="relative bg-(#0a0a0a) rounded-xl p-8">
                    <h3 className="text-2xl font-light mb-4">Tool runs</h3>
                    <p className="text-zinc-400 leading-relaxed mb-6">
                      Quote → build → sign → submit. Stellar + SoroSwap + Soroban RPC. You get txHash or quote back.
                    </p>
                    <a
                      href="https://github.com/stellar/stellar-agent-kit"
                      target="_blank"
                ...
                <div className="relative rounded-2xl border border-zinc-800 p-3">
                  ...
                  />
                  <div className="relative bg-(#0a0a0a) rounded-xl p-8">
                    <h3 className="text-2xl font-light mb-4">You get the result</h3>
                    <p className="text-zinc-400 leading-relaxed mb-6">
                      Balances, swap txHash, trustline confirmation, or a human-readable quote—right in the chat.
                    </p>
                    <a
                      href="https://github.com/stellar/stellar-agent-kit"
                      target="_blank"
